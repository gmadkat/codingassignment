...
/*
   @Test
    public void testCleanCategory() throws Exception {
        Categories c = new Categories("PEOPLE", "aaaaa");
        System.out.println(c);
        String catJson = this.json(new Categories("PEOPLE", "aaaaa"));
        this.mockMvc.perform(post("/category/cleanclass")
                .content(catJson)
...
*/
   ...
   @Test
    public void testCleanCategoryList() throws Exception {
        ArrayList<Categories> catlist = new ArrayList<Categories>();
        catlist.add(new Categories("PEOPLE", "aaaaa"));
